#ifndef _IMPLICITUPWIND_THOSMAS_H_ 
#define _IMPLICITUPWIND_THOSMAS_H_
...
namespace equation {
	...
	*/
	namespace scheme {
		/**
		* Class representing the Implicit upwind schemes. It solves the scheme by using Thomas Algorithm. It extends class Implicit Scheme
		...
		*/
		class ImplicitUpwind_Thomas :public ImplicitScheme {
			public:
			/**
			...
			*/
			ImplicitUpwind_Thomas::ImplicitUpwind_Thomas(double(*Initial_Function)(double x, double u), double(*Analytical_Function)(double x, double t, double u),
