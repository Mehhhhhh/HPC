...
ExplicitScheme::ExplicitScheme(double(*_Initial_Function)(double x, double u), double(*_Analytical_Function)(double x, double t, double u),
...
void equation::scheme::ExplicitScheme::GetValues()
{
	GetExplicitValue();
}
;
