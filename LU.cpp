...
void LU::lu_fact(const Matrix& a, Matrix& l, Matrix& u, int n) {
	Matrix temp = a;
	double mult;
...
void LU::lu_solve(const Matrix& l, const Matrix& u, const std::vector<double>& b, int n, std::vector<double>& x) {
